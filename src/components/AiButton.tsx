...
export type AiButtonBackground = "dark" | "light";
export type AiButtonSize = "medium" | "small" | "x-small";
export type AiButtonVariant = "primary" | "secondary" | "text";
...
function getIconFill(
  ...
  if (variant === "secondary" && background === "light") {
...
export function AiButton({
  ...
  const gradientId = `occam-ai-button-spark-${useId().replace(/:/g, "")}`;
  ...
  return (
    <button
      className={[
        ...
        .filter(Boolean)
        .join(" ")}
      data-occam-component="ai-button"
      type={type}
      {...props}
    >
      {showIcon ? (
